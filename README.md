...
- Calculates averages per university grading rules:  
  - Most subjects: `0.4 × TD + 0.6 × Exam`
  - Algorithmique et Structures de données: `0.2 × TD + 0.2 × TP + 0.6 × Exam`
...
1. Fill in your TD, TP (if available), and Exam grades for each subject.
2. Click **Calculate Average**.
3. See your semester average and a personalized comment below it.
